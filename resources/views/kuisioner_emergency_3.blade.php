...
<head>
	...
	<title>YMPI Kuisioner Emergency</title>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<div id="belum_mengisi" style="width: 100%;">
				...
				<label class="label-input1002">Apakah ada anggota keluarga Anda yang menjadi korban dari peristiwa tersebut ? <span style="color:red">*</span></label>

				<div class="validate-input" style="position: relative; width: 100%">
					<label class="radio" style="margin-top: 5px;margin-left: 5px">Iya
						<input type="radio"  id="jawaban" name="jawaban" value="Iya" onclick="changeJawaban(this.value)">
						<span class="checkmark"></span>
					</label>
					&nbsp;&nbsp;
					<label class="radio" style="margin-top: 5px">Tidak
						<input type="radio" id="jawaban" name="jawaban" value="Tidak" onclick="changeJawaban(this.value)">
						<span class="checkmark"></span>
					</label>
				</div>
				...
				<select class="form-control" data-placholder="Pilih Hubungan" name="hubungan" id="hubungan">
					<option value="-"></option>
				...
				<input type="hidden" class="form-control" id="keterangan" name="keterangan" value="Emergency 3">
          	...
          	<center style="font-size:20px">Terimakasih Bapak / Ibu <span class="name_assessment"></span> telah Mengisi Form Emergency ini pada <span style="color: red"><?= date('d M Y H:i:s') ?></span></center>
          	</div>
          </div>
		</div>
	</div>
