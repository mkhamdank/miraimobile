...
<body>
						...
						<form class="contact100-form validate-form" style="padding: 0px 25px 58px 25px;display: none" id="form_grup">
							...
							<div class="col-md-12 col-sm-12 col-xs-12" style="padding-left: 0;overflow-x: scroll;">
								...
								<form class="contact100-form validate-form" style="padding: 0px 25px 58px 25px;display: none" id="form_belum_survey">
									<div style="width: 100%;">
										<div class="col-xs-12 col-md-12">
											<center style="font-size:16px">Dear <span class="name_survey"></span><br>Survey Dapat Diisi Pada <span style="color: red">Minggu, 27 Februari 2022 Pukul 12:00 - 18:00 </span> <br></center>
										</div>
									</div>
    ...
    //   			console.log(parseInt('{{$pkb_question_total}}'));
				...
				function tab(index) {
					...
					if (index === 5) {
						if (tgl >= "2022-02-27 11:00:00" && tgl <= "2022-02-27 18:00:00") {
							$('#form_kehadiran').hide();
							$('#form_menu').hide();
							$("#form_login").hide();
							$("#form_survey").show();
