...
<head>
	...
	<link rel="stylesheet" href="{{ url("datatable/dataTables.bootstrap.min.css")}}">
		...
		<div class="wrap-contact100 col-xs-12 col-md-8 col-md-offset-2" style="padding: 0 10px; padding-bottom: 6%;">
			...
			<div id="already_filled" style="width: 100%; display: none; margin-top: 5%;">
				<div class="col-xs-12 col-md-12">
					<center style="font-size: 20px">Thank You <span style="color: #3c8dbc;" id="vendor_name"></span> <br> For The Response. We Will Check it As Soon As Possible</center>
...
<script src="{{ url("datatable/buttons.dataTables.min.js")}}"></script>
